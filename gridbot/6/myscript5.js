...
<li>Grid'den aylık yüzde kazanç: <span  style="color: blue;">%${parseFloat((30 * ((gridprofit / yavilkbakiyeiste) * 100) / calculate_days_between(start_date, end_date)).toFixed(2))}</span></li>
