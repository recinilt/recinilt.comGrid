...
function hesaplabutton() {
    ...
    var result="";
    setTimeout(() => {
        result = mybacktest(symbol.value.toUpperCase().trim(), start.value.trim(), end.value.trim(), num_levels.value.trim(), comission.value.trim(), girilenilkbakiye.value.trim(), veriinterval.value.toLowerCase().trim(), start_date.value.trim(), end_date.value.trim());
